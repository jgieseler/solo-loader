...
*Hint: You can use the (automatic) download function described in the next section to let the subfolders be created initially automatically.*
...
Aug 20 2020 to the dir `/home/userxyz/solo/data/`. Right now rudimentary working with one download (1 file/day) per call.

```python
from epd_loader import *

epd_l2_download('ept', 'north', 20200820, '/home/userxyz/solo/data/l2/epd/')
```
...
epd_ll_download('ept', 'north', 20200820, '/home/userxyz/solo/data/ll/epd/')
```
